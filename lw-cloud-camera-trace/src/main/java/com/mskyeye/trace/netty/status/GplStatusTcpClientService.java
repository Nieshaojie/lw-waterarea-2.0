...
/**
 * @ClassName:GplStatusTcpClientService
 * @Description:高普乐相机状态端口TCP客户端
 * @Author:R.Gong
 * @Date:2024/4/24 9:07
 * @Version:1.0
 **/
public class GplStatusTcpClientService {
    ...
    public boolean createTcpConn() {
        ...
        StatusClientHandlerInitializer client = new StatusClientHandlerInitializer();
